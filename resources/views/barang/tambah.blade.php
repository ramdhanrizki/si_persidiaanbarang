    ...
    <div class="col-md-6">
        ...
        <form role="form" method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kode_barang" name="kode_barang" placeholder="Masukkan Kode Barang" data-validation="required">
            </div>
            <div class="form-group">
                <label for="nama_barang">Nama Barang</label>
                <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Masukkan Nama Barang" data-validation="required">
            </div>
            <div class="form-group">
