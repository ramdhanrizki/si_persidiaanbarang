    ...
    <div class="col-md-6">
        ...
        <form role="form" method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="harga" placeholder="Masukkan Harga satuan barang" data-validation="required">
            </div>
            <div class="form-group">
                <label >Jumlah</label>
                <input type="number" name="jumlah" data-validation="required" class="form-control">
            </div>
